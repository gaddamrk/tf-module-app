    ...
    "Statement": [
      {
        ...
        "Resource": [
          "arn:aws:ssm:us-east-1:650202217229:parameter/${var.env}.${var.component}*",
          "arn:aws:ssm:us-east-1:650202217229:parameter/nexus*",
          "arn:aws:ssm:us-east-1:650202217229:parameter/${var.env}.docdb*"
        ]
      },
      {
        "Sid": "VisualEditor1",
